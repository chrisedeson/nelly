    ...
    >
      <div className="max-w-[700px] mx-auto">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h2
            id="contact-heading"
            className="font-['Raleway:ExtraBold',sans-serif] font-extrabold text-white text-2xl md:text-3xl lg:text-[34px] mb-4"
          >
            Get In Touch
          </h2>
          <p
            id="contact-description"
            className="font-['IBM_Plex_Mono:Regular',sans-serif] text-[#9c9c9c] text-sm md:text-base max-w-[570px] mx-auto leading-relaxed"
          >
        ...
        >
          <div>
            <label
              ...
              className="block font-['IBM_Plex_Mono:SemiBold',sans-serif] text-white text-xs mb-2"
            >
              Name
            </label>
            <input
          ...
          <button
            ...
            aria-label={submitting ? "Sending message..." : "Submit contact form"}
          >
            <span className="font-['IBM_Plex_Mono:Bold',sans-serif] text-sm">
              {submitting ? "Sending..." : "Submit"}
            </span>
            <svg className="h-2.5 w-1.5" fill="none" viewBox="0 0 6 10" aria-hidden="true" focusable="false">
